...
const HeroSection = () => (
  <section className="min-h-screen flex items-center section-padding pt-32">
    <div className="max-w-6xl mx-auto w-full">
      ...
      >
        QA lead from Vijayawada, currently working in Hyderabad, India. Passionate about ensuring software quality and delivering seamless digital experiences.
      </motion.p>
      <motion.a
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        ...
        href="#contact"
        className="inline-block font-mono text-sm border border-primary text-primary px-8 py-4 rounded transition-all duration-300 hover:bg-primary/10"
      >
        Get In Touch
      </motion.a>
    </div>

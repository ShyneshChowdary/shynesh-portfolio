      ...
      <div className="max-w-3xl mx-auto">
        ...
        >
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              I'm a QA lead currently working for <span className="text-primary font-medium">WYSERA</span>, where I focus on delivering high-quality, bug-free software. I enjoy the challenge of finding edge cases and ensuring every product meets the highest standards.
            </p>
            <p>
